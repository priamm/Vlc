...
import com.priamm.libvlc.Media;
import com.priamm.libvlc.MediaPlayer;
import com.priamm.libvlc.util.AndroidUtil;
import com.priamm.medialibrary.Medialibrary;
import com.priamm.medialibrary.Tools;
import com.priamm.medialibrary.interfaces.MediaUpdatedCb;
import com.priamm.medialibrary.media.MediaWrapper;
import com.priamm.vlc.BuildConfig;
import com.priamm.vlc.ExternalMonitor;
import com.priamm.vlc.MediaParsingService;
import com.priamm.vlc.PlaybackService;
import com.priamm.vlc.R;
import com.priamm.vlc.RecommendationsService;
import com.priamm.vlc.StartActivity;
import com.priamm.vlc.VLCApplication;
import com.priamm.vlc.gui.helpers.AudioUtil;
import com.priamm.vlc.gui.preferences.PreferencesActivity;
import com.priamm.vlc.gui.preferences.PreferencesFragment;
import com.priamm.vlc.gui.tv.audioplayer.AudioPlayerActivity;
import com.priamm.vlc.gui.tv.browser.BaseTvActivity;
import com.priamm.vlc.gui.tv.browser.MusicFragment;
import com.priamm.vlc.gui.tv.browser.VerticalGridActivity;
import com.priamm.vlc.media.MediaDatabase;
...
public class MainTvActivity extends BaseTvActivity implements OnItemViewSelectedListener,
    ...
    public void onItemClicked(Presenter.ViewHolder itemViewHolder, Object item, RowPresenter.ViewHolder rowViewHolder, Row row) {
        if (row.getId() == HEADER_CATEGORIES) {
            ...
            if (id == ID_SETTINGS) startActivityForResult(new Intent(this, com.priamm.vlc.gui.tv.preferences.PreferencesActivity.class), ACTIVITY_RESULT_PREFERENCES);
            else if (id == ID_ABOUT) startActivity(new Intent(this, com.priamm.vlc.gui.tv.AboutActivity.class));
            else if (id == ID_LICENCE) startActivity(new Intent(this, com.priamm.vlc.gui.tv.LicenceActivity.class));
